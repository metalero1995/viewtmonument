...
<div class="">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2>Editar perfiles/roles <small></small></h2>
        ...
        <div class="x_content">
          <br />
          <form id="demo-form2" name="frmregistra" action="{{route('perfil.update',['id'=>$data->PerfilID])}}" method="post" data-parsley-validate class="form-horizontal form-label-left">
            @csrf
            @method('PUT')
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <input value="{{$data->descripcion}}" type="text" id="descripcion2" name="descripcion" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input value="{{$data->comentario}}" type="text" id="comentario2" name="comentario" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
