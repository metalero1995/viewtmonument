...
<div class="">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Crear valoraciones de monumentos</h2>
                ...
                <div class="x_content">
                    <br />
                    <form id="" data-parsley-validate class="form-horizontal form-label-left" name="frmcreate" method="post" action="{{route('valoracion.store')}}">
                        @csrf
                        <div class="form-group">
                            <label for="descripcion2" class="control-label col-md-3 col-sm-3 col-xs-12">Valoración</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input class="form-control  col-md-7 col-xs-12" type="text" value="{{ old('descripcion') }}" name="descripcion" id="descripcion2">
                            </div>
                        </div>
                        <div class="ln_solid"></div>
                        <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                <a class="btn btn-danger" href="{{ route('valoracion.index') }}" type="button">Cancelar</a>
    ...
    function ModalCrear() {
        ...
        if ($('#descripcion2').val().length != 0) {
            ...
            if ($("#descripcion2").hasClass("parsley-error") == false) {
                ...
                setTimeout(() => {
                    Swal.fire({
                        title: '¿Seguro que quieres crear la valoracion?',
                        icon: 'question',
                        ...
                        if (result.isConfirmed) {
                            document.forms["frmcreate"].submit();
                        }
                    })
                }, 300);
            }
