...
<div class="">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2>Crear paises <small></small></h2>
        ...
        <div class="x_content">
          <br />
          <form id="demo-form2" name="frmregistra" action="{{route('pais.store')}}" method="post" data-parsley-validate class="form-horizontal form-label-left">
            @csrf
            <div class="form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Nombre <span class="required">*</span>
              </label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="nombre_pais2" name="nombre_pais" value="{{ old('nombre_pais') }}" required="required" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="descripcion_pais2" value="{{ old('descripcion_pais') }}" name="descripcion_pais" required="required" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
  ...
  function ModalCrear() {
    ...
    if ($('#nombre_pais2').val().length != 0 && $('#descripcion_pais2').val().length != 0) {
      ...
      if ($("#nombre_pais2").hasClass("parsley-error") == false && $("#descripcion_pais2").hasClass("parsley-error") == false) {
        ...
        setTimeout(() => {
          Swal.fire({
            title: '¿Seguro que quieres crear el pais?',
            icon: 'question',
