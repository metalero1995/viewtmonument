...
<div class="">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Crear estatus de reportes <small></small></h2>
                ...
                <div class="x_content">
                    <br />
                    <form id="demo-form2" name="frmregistra" action="{{route('reporte_estatus.store')}}" method="post" data-parsley-validate class="form-horizontal form-label-left">
                        @csrf
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Comentario <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="comentario2" value="{{ old('comentario') }}" name="comentario" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
    ...
    function ModalCrear() {
        ...
        if ($('#comentario2').val().length != 0 && $('#descripcion2').val().length != 0) {
            ...
            if ($("#comentario2").hasClass("parsley-error") == false && $("#descripcion2").hasClass("parsley-error") == false) {
                ...
                setTimeout(() => {
                    Swal.fire({
                        title: '¿Seguro que quieres crear el estatus de reporte?',
                        icon: 'question',
